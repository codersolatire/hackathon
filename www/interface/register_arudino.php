          ...
          <div class="col-md-6" data-aos="fade-up">
            <form action="#">
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  <label class="" for="clgName">Institution Name</label>
                  <input type="text" id="clgName" name = "clgName" class="form-control">
                </div>
              </div>
              ...
              <div class = "row form-group">
                <div class="col-md-6">
				 ...
				 <div class="col-md-6">
                  ...
                  <input type="number" minlength = "13" maxlength = "13" id="mobile" name = "mobile" class="form-control">
                </div>
				</div>
