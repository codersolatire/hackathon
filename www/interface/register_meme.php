...
<html lang="en">
  <head>
    <title>Meme_Design &mdash; Colorlib Website Template</title>
    <meta charset="utf-8">
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-10">
            ...
            <h1 class="d-block mb-4" data-aos="fade-up" data-aos-delay="100">Meme_Design Registration</h1>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          ...
          <div class="col-md-5 ml-auto" data-aos="fade-up" data-aos-delay="100">
            <div class="p-4 mb-3">
              ...
              <p class="mb-4">Theme: HSST Management!</p>
