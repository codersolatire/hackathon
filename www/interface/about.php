  ...
  <div class="site-wrap">
    ...
    <div class="site-section">
      <div class="container">
        <div class="row mb-5">
          <div class="col-lg-4 ">
            <div class="site-section-heading" data-aos="fade-up" data-aos-delay="100">
              <h2>Welcome To Hackathon 2.0</h2>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-md-4" data-aos="fade-up" data-aos-delay="400"><img src="/images/pps.jpg" alt="Image" class="img-fluid">
          ...
          <div class="col-md-8" data-aos="fade-up" data-aos-delay="500">
            ...
            <div class="d-flex coordinator align-items-center">
              ...
              <span>By <span class="text-white">Parth Singh</span> <br> Event Coordinator</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        ...
        <div class="row">
            ...
            <div class="testimony text-center"> 
              ...
              <blockquote>
                <p class="author mb-0">Vedansh Sahu</p>
		  ...
		  <div class="col-md-6 col-lg-4 mb-5 mb-lg-5" data-aos="fade-up" data-aos-delay="300">
            <div class="testimony text-center"> 
              ...
              <blockquote>
                <p class="author mb-0">Nainsi Rautela</p>
                <p class="text-muted mb-4">Coordinator</p>
                </blockquote>
            </div>
          </div>
            ...
            <div class="testimony text-center"> 
              ...
              <blockquote>
                <p class="author mb-0">Vedgya Vyas</p>
                <p class="text-muted mb-4">Coordinator</p>
				</blockquote>
            </div>
          </div>
            ...
            <div class="testimony text-center">
              ...
              <blockquote>
                <p class="author mb-0">Sandesh Singh</p>
                <p class="text-muted mb-4">Coordinator</p>
          ...
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-5" data-aos="fade-up" data-aos-delay="200">
            <div class="testimony text-center"> 
              ...
              <blockquote>
                <p class="author mb-0">Riya Yadav</p>
                <p class="text-muted mb-4">Coordinator</p>
                </blockquote>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-5" data-aos="fade-up" data-aos-delay="100">
            <div class="testimony text-center">
              ...
              <blockquote>
                <p class="author mb-0">Mirika Kesarvani</p>
                <p class="text-muted mb-4">Coordinator</p>
		  ...
		  <div class="col-md-6 col-lg-4 mb-5 mb-lg-5" data-aos="fade-up" data-aos-delay="300">
            <div class="testimony text-center">
              ...
              <blockquote>
                <p class="author mb-0">Vibhu Trivedi</p>
                <p class="text-muted mb-4">Coordinator</p>
          ...
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-5" data-aos="fade-up" data-aos-delay="200">
            <div class="testimony text-center">
              ...
              <blockquote>
                <p class="author mb-0">Anukriti Saxena</p>
                <p class="text-muted mb-4">Coordinator</p>
